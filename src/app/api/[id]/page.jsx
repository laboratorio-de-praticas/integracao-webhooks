    ...
    return (
        <div className="min-h-screen flex flex-col font-verdana">
            ...
            <main className="flex-1 flex justify-center bg-white">
                <section className="flex flex-col items-center w-full max-w-4/5 pb-10">
                    ...
                    <div className="text-gray-500 mt-5 w-full flex items-center">
                    ...
                    <p  className="mt-10 text-gray-500 self-start">Endpoins Atuais: </p>
